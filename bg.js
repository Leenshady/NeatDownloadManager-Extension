...
function updateContextMenu(tabId) {
    chrome.tabs.get(tabId, function (tab) {
        ...
        var title = isBlocked ? "Unblock downloads from this website" : "Block downloads from this website";
...
function U() {
    var a = this.constructor.prototype, b; for (b in a) this[b] = a[b].bind(this); this.H = {}; this.h = {}; this.m = {}; this.fa = 1; this.u = ""; this.C = !1; chrome.contextMenus.removeAll(); chrome.contextMenus.create({ title: "Download by NeatDownloadManager", id: "NDM_CtxMenu", contexts: ["link", "image"] }); this.j(chrome.contextMenus.onClicked, this.W); this.j(chrome.downloads.onCreated, this.X); this.j(chrome.runtime.onConnect, this.Z); this.j(chrome.webRequest.onBeforeRequest, this.T, {
        urls: ["http://*/*", "https://*/*", "ftp://*/*"],
        types: w
